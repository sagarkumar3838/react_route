  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <section className="overflow-hidden max-w-full mt-4 px-4 md:px-8 lg:px-16 py-12 grid grid-cols-1 md:grid-cols-2 gap-5 mx-auto">
        ...
        <section className="mt-8 text-center w-full px-4 md:px-8 lg:px-16 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-16 max-w-6xl mx-auto">
          <div>
...
const squareData = [
  {
    id: 1,
    src: "https://images.unsplash.com/photo-1547347298-4074fc3086f0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB 8fHx8&auto=format&fit=crop&w=1740&q=80",
  },
  {
    id: 2,
