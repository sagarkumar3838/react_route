 ...
 const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20  overflow-hidden max-w-full mx-auto ",
        className
      )}
    >
      <ul
      ...
      >
        {items.map((item) => (
          <li
            className=" max-w-full relative rounded-xl  flex-shrink-0  px-4 py-6 w-[80px] md:w-[120px] lg:w-[160px]"
...
export function InfiniteMovingCardsDemo() {
  ...
  return (
    <div className="  h-[4rem]  flex flex-col antialiased bg-gray-900 dark:bg-white dark:bg-grid-white/[0.05]  justify-evenly relative overflow-hidden flex-none   p-2 ">
