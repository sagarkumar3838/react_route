        ...
        <StyledWrapper className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
            <div className="parent">
                ...
                <path id="Path_8" data-name="Path 8" d="M0,80.018A1.561,1.561,0,0,1,1.483,78.39h26.7a1.561,1.561,0,0,1,1.483,1.628v2.006a1.561,1.561,0,0,1-1.483,1.628H1.483A1.561,1.561,0,0,1,0,82.025Z" transform="translate(0 -51.963)" />
                    ...
                    <div className="glass p-[14px] pt-[14px] pr-[14px]  pl-[14px]" >
                        <img src={Poster} alt="Movie Poster" className='w-full h-full object-cover rounded-[24px]  border-top-right-radius: %;
...
const StyledWrapper = styled.div`
  ...
  .content {
    ...
    position: relative; /* Ensure the content is positioned relative for absolute children */
